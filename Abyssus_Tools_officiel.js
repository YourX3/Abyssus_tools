...
function init(){
	...
	textVersion.innerHTML = '<font size="1" color="white">Abyssus Tools V 0.5 __ Last Updtate 12/06/2018 18h47 </font>';
...
function page_membres(){
	if(sessionStorage.getItem("displayingDistances_total") === null){
		...
		var insertContainer = document.getElementsByTagName("bloc")[0];
