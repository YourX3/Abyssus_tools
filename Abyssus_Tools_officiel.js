...
function init(){
	...
	textVersion.innerHTML = '<font size="1" color="white">Abyssus Tools V 0.7 __ Last Updtate 03/07/2018 22h55 </font>';
					...
					if(time !== "inconnu"){
						...
						for(var i=0; i < currentAtks.length; ++i){
							if(indexsOfAtks.includes(i)){
								var army = currentAtks[i].childNodes[currentAtks[i].childNodes.length-1];
